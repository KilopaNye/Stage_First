...
fetch("https://padax.github.io/taipei-day-trip-resources/taipei-attractions-assignment.json").then(function (response) {
    ...
    for (let i = 4; i < 16; i++) {
        //選擇父層
        let secondFa = document.querySelector(".photoBox");
        let firstDiv = document.createElement("div");
        firstDiv.classList.add("secondPhoto", "box" + i);
        secondFa.appendChild(firstDiv);

        let secondPhoto = document.querySelector(".box" + i);
        ...
        secondPhoto.appendChild(fragmentSecond);
        //------------------------------以下為欲新增的標籤---------------------------------
        //添加文字BOX
...
// <div class="secondPhoto box4"></div>
// 參考架構
// <div class="secondPhoto" "box4" >
